...
@endif
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                    <div   class="card" >
                        ...
                        <div class="body" >
                            <form method="post" action="{{url('say')}}" enctype="multipart/form-data">
                              {{csrf_field()}}
                              ...
                              <label for="email_address">Name </label>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" required="" name="description" required="" class="form-control" placeholder="Description">
                                    </div>
                                </div>
                                 <label for="email_address">Role</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" required="" name="role" required="" class="form-control" placeholder="Role">
                                    </div>
                                </div>
